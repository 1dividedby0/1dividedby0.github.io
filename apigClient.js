...
apigClientFactory.newClient = function (config) {
    ...
    apigClient.classifyGet = function (params, body, additionalParams) {
        ...
        return apiGatewayClient.makeRequest(classifyGetRequest, authType, additionalParams, config.apiKey);
    };
